...
/* 8x16 ASCII font table (0x20 ' ' to 0x7E '~')
 * Each character is 16 bytes, each byte represents one row (8 pixels)
 */
static const uint8_t font_8x16[96][16] = {
    /* 0x20 ' ' */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    /* 0x21 '!' */ {0x00,0x00,0x00,0x18,0x3C,0x3C,0x18,0x18,0x18,0x00,0x18,0x18,0x00,0x00,0x00,0x00},
    ...
    /* 0x24 '$' */ {0x00,0x18,0x3C,0x60,0x7C,0x66,0x66,0x66,0x66,0x7C,0x60,0x3C,0x18,0x00,0x00,0x00},
    /* 0x25 '%' */ {0x00,0x00,0x00,0x00,0x66,0x66,0x0C,0x18,0x30,0x60,0x66,0x66,0x00,0x00,0x00,0x00},
    ...
    /* 0x4B 'K' */ {0x00,0x00,0xE6,0x66,0x6C,0x6C,0x78,0x78,0x6C,0x6C,0x66,0xE6,0x00,0x00,0x00,0x00},
...
const uint8_t *LCD_Font_GetChar(char ch, FontSize_t size)
{
    if (ch < 0x20 || ch > 0x7E)
    {
        ch = 0x20;  /* Replace with space */
    }

    /* All sizes use the same 8x16 base font; larger sizes are scaled in drawing */
...
uint8_t LCD_Font_GetWidth(FontSize_t size)
{
    switch (size)
    {
    case FONT_SMALL:  return FONT_SMALL_W;
    case FONT_MEDIUM: return FONT_MEDIUM_W;
    case FONT_LARGE:  return FONT_LARGE_W;
    default:          return FONT_SMALL_W;
    }
}
...
uint8_t LCD_Font_GetHeight(FontSize_t size)
{
    switch (size)
    {
    case FONT_SMALL:  return FONT_SMALL_H;
    case FONT_MEDIUM: return FONT_MEDIUM_H;
    case FONT_LARGE:  return FONT_LARGE_H;
    default:          return FONT_SMALL_H;
    }
}
